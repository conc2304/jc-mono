...
export const lightformWebControllerProject: ProjectData = {
  ...
  // =============================================================================
  content: {
    synopsis: `Led development of a comprehensive web-based ecosystem for Lightform's AR projection mapping hardware, consisting of two integrated applications: a First Time User Experience (FTUX) app for device setup running through Android WebView, and a Progressive Web App controller for real-time projection mapping management. Built with StencilJS and TypeScript, the system features a custom virtual keyboard for D-pad navigation, P5.js-powered corner pinning for precision alignment, and cross-platform PWA functionality. The applications successfully transitioned Lightform from serving primarily professional markets to enabling home consumers to create projection mapping experiences, democratizing access to AR projection technology through intuitive mobile and desktop interfaces.`,
