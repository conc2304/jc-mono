...
export const blueLightBeveledTheme = createTheme(beveledThemeContract, {
  // Similar structure but with blue-specific color mappings
  components: {
    button: {
      // ... blue-specific button styles
    },
    card: {
      // ... blue-specific card styles
    },
  },
});

export const blueDarkBeveledTheme = createTheme(beveledThemeContract, {
  // Similar structure but with blue dark-specific color mappings
  components: {
    button: {
      // ... blue dark-specific button styles
    },
    card: {
      // ... blue dark-specific card styles
    },
  },
});
