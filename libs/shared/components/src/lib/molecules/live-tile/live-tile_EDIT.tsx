...
import { BaseFileSystemItem, TileRenderer } from '@jc/file-system';
import { DefaultTileContent } from './default-tile-content';
import { ChevronRight, Folder } from 'lucide-react';
import { Star } from '@mui/icons-material';
import { useMediaQuery } from '@mui/system';
import { ResponsiveBreakpointConfig, Tile } from '../../organisms';
...
export const LiveTile_EDIT = memo<LiveTileProps>(
  ({
    // position,
    isDragging = false,
    fileItem : {id,
